...
export const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed top-0 w-full z-50 transition-all duration-500 ease-in-out border-b border-white/5 ${
        isScrolled
          ? "py-3 bg-[#05050a]/80 backdrop-blur-xl shadow-2xl"
          : "py-5 bg-transparent"
      }`}
    >
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        <div
          className={`fixed inset-0 h-screen bg-[#05050a]/95 backdrop-blur-xl flex flex-col items-center justify-center transition-all duration-500 ease-in-out md:hidden z-[55] ${
            isMenuOpen
              ? "translate-y-0 opacity-100"
              : "-translate-y-full opacity-0"
          }`}
